            ...
            <tbody>
              <tr className="border-b border-neutral-100 hover:bg-neutral-50">
                <td className="py-2 px-1 md:py-4 md:px-6">
                  <div>
                    <p className="font-bold text-xs md:text-lg text-text-primary leading-tight">{data.politician}</p>
                  </div>
                </td>
                <td className="py-2 px-1 md:py-4 md:px-6">
                ...
                <td className="py-2 px-[3.6px] md:py-4 md:px-6 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-0.5 md:gap-2 px-2 py-1 md:px-6 md:py-2.5 bg-primary-500 text-white rounded-[24px] hover:bg-primary-600 transition-colors font-medium shadow-sm hover:shadow-md whitespace-nowrap text-[10px] md:text-base"
                  >
                    詳細
