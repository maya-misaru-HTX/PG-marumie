          ...
          <table className="w-full md:table-auto">
            <thead className="sticky top-0 bg-white border-b-2 border-neutral-200 z-10">
              <tr>
                ...
                <th
                  className="text-right py-2 px-2 md:py-3 md:px-4 cursor-pointer hover:bg-neutral-50 w-[35%] md:w-auto"
                ...
                <th
                  className="text-left py-2 px-2 md:py-3 md:px-4 cursor-pointer hover:bg-neutral-50 w-[25%] md:w-auto whitespace-nowrap"
            ...
            <tbody>
              {filteredTransactions.map((transaction) => (
                ...
                >
                  ...
                  <td
                    className={`py-2 px-2 md:py-3 md:px-4 text-right text-[0.825rem] md:text-[0.9625rem] font-medium w-[35%] md:w-auto whitespace-nowrap ${
                  ...
                  <td className="py-2 px-2 md:py-3 md:px-4 text-[0.825rem] md:text-[0.9625rem] text-text-secondary w-[25%] md:w-auto whitespace-nowrap">
